...
<body>
    ...
    <table border="1">
        ...
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/api/novosti" target="_blank">localhost:8080/rest/api/novosti</a></td>
            <td>Prikazuje sve novosti u json formatu <br></td>
        </tr>
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/api/novosti/@id" target="_blank">localhost:8080/rest/api/novosti/@id</a></td>
            <td>prikazuje jednu novost za unesen @id</td>
        </tr>
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/api/kategorije" target="_blank">localhost:8080/rest/api/kategorije</a></td>
            <td>Prikazuje sve kategorije u json formatu</td>
        </tr>
        <tr>
            <td>GET</td>
            <td><a href="localhost:8080/rest/api/kategorije/@id" target="_blank">localhost:8080/rest/api/kategorije/@id</a></td>
            <td>prikazuje jednu kategoriju za unesen @id</td>
        </tr>
        <tr>
            <td>POST</td>
            <td>localhost:8080/rest/api/novosti</td>
            <td>Unosi jednu novost sa prosleđenim parametrima u json formatu u telu HTTP zahteva</td>
        </tr>
        <tr>
            <td>POST</td>
            <td>localhost:8080/rest/api/kategorije</td>
            <td>Unosi jednu kategoriju sa prosleđenim parametrima u json formatu u telu HTTP zahteva</td>
        </tr>
        <tr>
            <td>PUT</td>
            <td>localhost:8080/rest/api/novosti/@id</td>
            <td>Ažurira novost sa prosleđenim parametrima u json formatu u telu HTTP zahteva, čiji je id @id</td>
        </tr>
        <tr>
            <td>PUT</td>
            <td>localhost:8080/rest/api/kategorije/@id</td>
